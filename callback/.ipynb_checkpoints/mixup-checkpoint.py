...
class MixUpCallback(Callback):
    ...
    def on_train_begin(self, **kwargs):
        if self.stack_y: self.state.core.criterion = MixupLoss(self.state.core.criterion)
            
    def on_batch_begin(self, i:int, state:DotDict):
        if state.core.mode == "train":
            x = state.core.batch['inputs']
            y = state.core.batch['outputs']
            ...
            state.core.batch['inputs'] = new_input
            state.core.batch['outputs'] = new_target
            
    def on_train_end(self, **kwargs):
        self.state.core.criterion = self.state.core.criterion.get_old()
